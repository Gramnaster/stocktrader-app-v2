...
# Handle Cross-Origin Resource Sharing (CORS) in order to accept cross-origin Ajax requests.# Handle Cross-Origin Resource Sharing (CORS) in order to accept cross-origin Ajax requests.
